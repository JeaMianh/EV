...
## 
## Makefile     : NoBMS.mk
## Generated on : Wed Nov 26 22:42:55 2025
## Final product: ./NoBMSlib.lib
...
SRCS = $(START_DIR)/slprj/sim/NoBMS/NoBMS.c $(START_DIR)/slprj/sim/NoBMS/NoBMS_capi.c
...
%.obj : $(START_DIR)/slprj/sim/NoBMS/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoBMS/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoBMS/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoBMS/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoBMS/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
NoBMS.obj : $(START_DIR)/slprj/sim/NoBMS/NoBMS.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NoBMS_capi.obj : $(START_DIR)/slprj/sim/NoBMS/NoBMS_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
