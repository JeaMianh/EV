...
#define S_FUNCTION_NAME NoBMS_msf
#endif
...
static void mdlProcessParameters ( SimStruct * S ) { real32_T * o_o_o_B_1_3 =
( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_o_o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_o_o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { bsoby43i3xf * dw = ( bsoby43i3xf * ) ssGetDWork ( S , 0 ) ; boolean_T * o_o_B_1_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_o_o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_o_o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_o_o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; real32_T * o_o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; boolean_T * o_o_B_1_7 = ( boolean_T * ) ssGetOutputPortSignal ( S , 6 ) ; boolean_T * o_o_B_1_8 = ( boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ; boolean_T * o_o_B_1_9 = ( boolean_T * ) ssGetOutputPortSignal ( S , 8 ) ; boolean_T * o_o_B_1_10 = ( boolean_T * ) ssGetOutputPortSignal ( S , 9 ) ; boolean_T * o_o_B_1_11 = ( boolean_T * ) ssGetOutputPortSignal ( S , 10 ) ; boolean_T * o_o_B_1_12 = ( boolean_T * ) ssGetOutputPortSignal ( S , 11 ) ; boolean_T * o_o_B_1_13 = ( boolean_T * ) ssGetOutputPortSignal ( S , 12 ) ; l0xwxaulm2 ( o_o_B_1_1 , o_o_B_1_2 , o_o_o_B_1_3 , o_o_o_B_1_4 , o_o_o_B_1_5 , o_o_B_1_6 , o_o_B_1_7 , o_o_B_1_8 , o_o_B_1_9 , o_o_B_1_10 , o_o_B_1_11 , o_o_B_1_12 , o_o_B_1_13 , & ( dw -> rtb ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { bsoby43i3xf * dw = ( bsoby43i3xf * ) ssGetDWork ( S , 0 ) ; boolean_T * o_o_B_1_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_o_o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_o_o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_o_o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; real32_T * o_o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; boolean_T * o_o_B_1_7 = ( boolean_T * ) ssGetOutputPortSignal ( S , 6 ) ; boolean_T * o_o_B_1_8 = ( boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ; boolean_T * o_o_B_1_9 = ( boolean_T * ) ssGetOutputPortSignal ( S , 8 ) ; boolean_T * o_o_B_1_10 = ( boolean_T * ) ssGetOutputPortSignal ( S , 9 ) ; boolean_T * o_o_B_1_11 = ( boolean_T * ) ssGetOutputPortSignal ( S , 10 ) ; boolean_T * o_o_B_1_12 = ( boolean_T * ) ssGetOutputPortSignal ( S , 11 ) ; boolean_T * o_o_B_1_13 = ( boolean_T * ) ssGetOutputPortSignal ( S , 12 ) ; if ( tid == 0 ) { NoBMS ( o_o_B_1_1 , o_o_B_1_2 , o_o_o_B_1_3 , o_o_o_B_1_4 , o_o_o_B_1_5 , o_o_B_1_6 , o_o_B_1_7 , o_o_B_1_8 , o_o_B_1_9 , o_o_B_1_10 , o_o_B_1_11 , o_o_B_1_12 , o_o_B_1_13 , & ( dw -> rtb ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 0 , 13 ) ; if ( ! ssSetNumInputPorts ( S , 0 ) ) return ; if ( ! ssSetNumOutputPorts ( S , 13 ) ) return ; if ( ! ssSetOutputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetOutputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetOutputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetOutputPortDataType ( S , 0 , SS_BOOLEAN ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "A" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 3 , unitIdReg ) ;
#endif
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "A" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 4 , unitIdReg ) ;
#endif
...
mr_NoBMS_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_NoBMS_MdlInfoRegFcn ( S
, "NoBMS" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( bsoby43i3xf ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { bsoby43i3xf * dw = ( bsoby43i3xf * ) ssGetDWork ( S , 0 ) ; real32_T * o_o_o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_o_o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_o_o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } pngtqbyjyy ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , & ( dw -> rtm ) , & ( dw -> rtb ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { bsoby43i3xf * dw = ( bsoby43i3xf * )
ssGetDWork ( S , 0 ) ; real32_T * o_o_o_B_1_3 = ( real32_T * )
ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_o_o_B_1_4 = ( real32_T * )
ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_o_o_B_1_5 = ( real32_T * )
ssGetOutputPortSignal ( S , 4 ) ; plmdsubdlc ( o_o_o_B_1_3 , o_o_o_B_1_4 ,
o_o_o_B_1_5 , & ( dw -> rtb ) ) ; } static void mdlOutputs ( SimStruct * S ,
int_T tid ) { bsoby43i3xf * dw = ( bsoby43i3xf * ) ssGetDWork ( S , 0 ) ;
boolean_T * o_o_B_1_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_o_o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ;
real32_T * o_o_o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ;
real32_T * o_o_o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ;
real32_T * o_o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ;
boolean_T * o_o_B_1_7 = ( boolean_T * ) ssGetOutputPortSignal ( S , 6 ) ;
boolean_T * o_o_B_1_8 = ( boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ;
boolean_T * o_o_B_1_9 = ( boolean_T * ) ssGetOutputPortSignal ( S , 8 ) ;
boolean_T * o_o_B_1_10 = ( boolean_T * ) ssGetOutputPortSignal ( S , 9 ) ;
boolean_T * o_o_B_1_11 = ( boolean_T * ) ssGetOutputPortSignal ( S , 10 ) ;
boolean_T * o_o_B_1_12 = ( boolean_T * ) ssGetOutputPortSignal ( S , 11 ) ;
boolean_T * o_o_B_1_13 = ( boolean_T * ) ssGetOutputPortSignal ( S , 12 ) ;
if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { NoBMS ( o_o_B_1_1
, o_o_B_1_2 , o_o_o_B_1_3 , o_o_o_B_1_4 , o_o_o_B_1_5 , o_o_B_1_6 , o_o_B_1_7
, o_o_B_1_8 , o_o_B_1_9 , o_o_B_1_10 , o_o_B_1_11 , o_o_B_1_12 , o_o_B_1_13 ,
& ( dw -> rtb ) ) ; } } static void mdlTerminate ( SimStruct * S ) {
bsoby43i3xf * dw = ( bsoby43i3xf * ) ssGetDWork ( S , 0 ) ; nq2oylqrrn ( & ( dw
-> rtm ) ) ; return ; }
...
mdlrefDW = mr_NoBMS_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss
, 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_NoBMS_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 , 2 ,
...
mr_NoBMS_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 , 1 )
