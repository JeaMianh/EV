###########################################################################
## Makefile generated for component 'NoBMS'. 
## 
## Makefile     : NoBMS.mk
## Generated on : Wed Nov 26 22:42:56 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/NoBMS_msf.mexw64
...
MODELREF_LINK_RSPFILE     = NoBMS_ref.rsp
COMPILER_COMMAND_FILE     = NoBMS_comp.rsp
CMD_FILE                  = NoBMS.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/NoBMS_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=NoBMS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/NoBMS/NoBMS_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = NoBMS_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/GraduationProject/EV/VirtualVehicle/VirtualVehicle/Work/slprj/sim/NoBMS/NoBMSlib.lib
...
NoBMS_msf.obj : $(START_DIR)/slprj/sim/NoBMS/NoBMS_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
