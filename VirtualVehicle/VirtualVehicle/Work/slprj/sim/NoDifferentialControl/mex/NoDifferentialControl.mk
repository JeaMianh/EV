...
## Generated on : Wed Nov 26 22:43:01 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/NoDifferentialControl_msf.mexw64
...
MODELREF_LINK_RSPFILE     = NoDifferentialControl_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/NoDifferentialControl_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/NoDifferentialControl/NoDifferentialControl_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = NoDifferentialControl_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/GraduationProject/EV/VirtualVehicle/VirtualVehicle/Work/slprj/sim/NoDifferentialControl/NoDifferentialControllib.lib
...
NoDifferentialControl_msf.obj : $(START_DIR)/slprj/sim/NoDifferentialControl/NoDifferentialControl_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
