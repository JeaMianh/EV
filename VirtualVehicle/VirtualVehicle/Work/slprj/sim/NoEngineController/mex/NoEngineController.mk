...
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/NoEngineController_msf.mexw64
...
MODELREF_LINK_RSPFILE     = NoEngineController_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/NoEngineController_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/NoEngineController/NoEngineController_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = NoEngineController_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/GraduationProject/EV/VirtualVehicle/VirtualVehicle/Work/slprj/sim/NoEngineController/NoEngineControllerlib.lib
...
NoEngineController_msf.obj : $(START_DIR)/slprj/sim/NoEngineController/NoEngineController_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
