...
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/NoThermalControl_msf.mexw64
...
MODELREF_LINK_RSPFILE     = NoThermalControl_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/NoThermalControl_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/NoThermalControl/NoThermalControl_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = NoThermalControl_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/GraduationProject/EV/VirtualVehicle/VirtualVehicle/Work/slprj/sim/NoThermalControl/NoThermalControllib.lib
...
NoThermalControl_msf.obj : $(START_DIR)/slprj/sim/NoThermalControl/NoThermalControl_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
