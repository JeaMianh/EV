...
## 
## Makefile     : NoVCU.mk
## Generated on : Thu Nov 27 15:01:05 2025
## Final product: ./NoVCUlib.lib
...
SRCS = $(START_DIR)/slprj/sim/NoVCU/NoVCU.c $(START_DIR)/slprj/sim/NoVCU/NoVCU_capi.c
...
%.obj : $(START_DIR)/slprj/sim/NoVCU/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoVCU/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoVCU/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoVCU/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/NoVCU/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
NoVCU.obj : $(START_DIR)/slprj/sim/NoVCU/NoVCU.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NoVCU_capi.obj : $(START_DIR)/slprj/sim/NoVCU/NoVCU_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
