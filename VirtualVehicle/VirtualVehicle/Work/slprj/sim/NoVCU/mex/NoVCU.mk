###########################################################################
## Makefile generated for component 'NoVCU'. 
## 
## Makefile     : NoVCU.mk
## Generated on : Thu Nov 27 15:01:09 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/NoVCU_msf.mexw64
...
MODELREF_LINK_RSPFILE     = NoVCU_ref.rsp
COMPILER_COMMAND_FILE     = NoVCU_comp.rsp
CMD_FILE                  = NoVCU.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/NoVCU_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=NoVCU -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/NoVCU/NoVCU_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = NoVCU_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/GraduationProject/EV/VirtualVehicle/VirtualVehicle/Work/slprj/sim/NoVCU/NoVCUlib.lib
...
NoVCU_msf.obj : $(START_DIR)/slprj/sim/NoVCU/NoVCU_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
