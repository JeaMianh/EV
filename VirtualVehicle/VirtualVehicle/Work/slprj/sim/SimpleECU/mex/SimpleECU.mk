###########################################################################
## Makefile generated for component 'SimpleECU'. 
## 
## Makefile     : SimpleECU.mk
## Generated on : Thu Nov 27 15:01:20 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SimpleECU_msf.mexw64
...
MODELREF_LINK_RSPFILE     = SimpleECU_ref.rsp
COMPILER_COMMAND_FILE     = SimpleECU_comp.rsp
CMD_FILE                  = SimpleECU.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SimpleECU_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=SimpleECU -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/SimpleECU/SimpleECU_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = SimpleECU_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/GraduationProject/EV/VirtualVehicle/VirtualVehicle/Work/slprj/sim/SimpleECU/SimpleECUlib.lib
...
SimpleECU_msf.obj : $(START_DIR)/slprj/sim/SimpleECU/SimpleECU_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
