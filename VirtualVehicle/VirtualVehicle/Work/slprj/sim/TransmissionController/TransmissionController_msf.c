...
#define S_FUNCTION_NAME TransmissionController_msf
#endif
...
real_T rtP__CtrlTcuDnLdBpt2f2Drivetrain_sldd_ [ 4 ] ; real_T
rtP__CtrlTcuDnShSpd2f2Drivetrain_sldd_ [ 56 ] ; real_T
rtP__CtrlTcuInitGear2f2Drivetrain_sldd_ ; real_T
rtP__CtrlTcuLugSpd2f2Drivetrain_sldd_ ; real_T
rtP__CtrlTcuMinUpSpd2f2Drivetrain_sldd_ ; real_T
rtP__CtrlTcuTmDnSh2f2Drivetrain_sldd_ ; real_T
rtP__CtrlTcuTmUpSh2f2Drivetrain_sldd_ ; real_T
rtP__CtrlTcuUpLdBpt2f2Drivetrain_sldd_ [ 4 ] ; real_T
rtP__CtrlTcuUpShSpd2f2Drivetrain_sldd_ [ 56 ] ; const char *
...
static void mdlProcessParameters ( SimStruct * S ) { real_T * GlobalPrm_0 = ( real_T * ) NULL ; real_T * GlobalPrm_1 = ( real_T * ) NULL ; real_T * GlobalPrm_2 = ( real_T * ) NULL ; real_T * GlobalPrm_3 = ( real_T * ) NULL ; real_T * GlobalPrm_4 = ( real_T * ) NULL ; real_T * GlobalPrm_5 = ( real_T * ) NULL ; real_T * GlobalPrm_6 = ( real_T * ) NULL ; real_T * GlobalPrm_7 = ( real_T * ) NULL ; real_T * GlobalPrm_8 = ( real_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuDnLdBpt2f2Drivetrain_sldd_ [ 0 ] ) , GlobalPrm_0 , sizeof ( real_T ) * 4 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuDnShSpd2f2Drivetrain_sldd_ [ 0 ] ) , GlobalPrm_1 , sizeof ( real_T ) * 56 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuInitGear2f2Drivetrain_sldd_ ) , GlobalPrm_2 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 3 , ( void * * ) ( & GlobalPrm_3 ) ) ) return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuLugSpd2f2Drivetrain_sldd_ ) , GlobalPrm_3 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 4 , ( void * * ) ( & GlobalPrm_4 ) ) ) return ; if ( GlobalPrm_4 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuMinUpSpd2f2Drivetrain_sldd_ ) , GlobalPrm_4 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 5 , ( void * * ) ( & GlobalPrm_5 ) ) ) return ; if ( GlobalPrm_5 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuTmDnSh2f2Drivetrain_sldd_ ) , GlobalPrm_5 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 6 , ( void * * ) ( & GlobalPrm_6 ) ) ) return ; if ( GlobalPrm_6 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuTmUpSh2f2Drivetrain_sldd_ ) , GlobalPrm_6 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 7 , ( void * * ) ( & GlobalPrm_7 ) ) ) return ; if ( GlobalPrm_7 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuUpLdBpt2f2Drivetrain_sldd_ [ 0 ] ) , GlobalPrm_7 , sizeof ( real_T ) * 4 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 8 , ( void * * ) ( & GlobalPrm_8 ) ) ) return ; if ( GlobalPrm_8 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuUpShSpd2f2Drivetrain_sldd_ [ 0 ] ) , GlobalPrm_8 , sizeof ( real_T ) * 56 ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { dosld0bzlxb * dw = ( dosld0bzlxb * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; bi3mvnnhxb ( o_o_o_B_5_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { dosld0bzlxb * dw = ( dosld0bzlxb * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; asexx13y03 ( o_o_o_B_5_1 , & ( dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { dosld0bzlxb * dw = ( dosld0bzlxb * ) ssGetDWork ( S , 0 ) ; real_T const * i_ae43qptnn3 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_iyfstowtw1 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_fkscd5rt0o = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_bguulprmhf = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_fazveiy2i4 = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; boolean_T const * i_kocp0nosoq = ( boolean_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) { TransmissionController ( i_ae43qptnn3 , i_iyfstowtw1 , i_fkscd5rt0o , i_bguulprmhf , i_fazveiy2i4 , i_kocp0nosoq , o_o_o_B_5_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 6 , 1 ) ; if ( ! ssSetNumInputPorts ( S , 6 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "m/s" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetInputPortUnit ( S , 2 , unitIdReg ) ;
#endif
...
mr_TransmissionController_RegisterSimStateChecksum ( S ) ;
...
mr_TransmissionController_MdlInfoRegFcn ( S , "TransmissionController" , &
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( dosld0bzlxb ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { dosld0bzlxb * dw = ( dosld0bzlxb * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } pffr22s23c ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mdlProcessParameters ( S ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { dosld0bzlxb * dw = ( dosld0bzlxb * ) ssGetDWork ( S , 0 ) ; real_T const * i_ae43qptnn3 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_iyfstowtw1 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_fkscd5rt0o = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_bguulprmhf = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_fazveiy2i4 = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; boolean_T const * i_kocp0nosoq = ( boolean_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { TransmissionController ( i_ae43qptnn3 , i_iyfstowtw1 , i_fkscd5rt0o , i_bguulprmhf , i_fazveiy2i4 , i_kocp0nosoq , o_o_o_B_5_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void mdlTerminate ( SimStruct * S ) { dosld0bzlxb * dw = ( dosld0bzlxb * ) ssGetDWork ( S , 0 ) ; g2lk0g2ith ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_TransmissionController_GetDWork ( ssGetDWork ( S , 0 ) ) ;
...
mr_TransmissionController_SetDWork ( ssGetDWork ( S , 0 ) ,
